...
QT_TRANSLATE_NOOP("bitcoin-core", "Kuberbitcoin version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Kuberbitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or kuberbitcoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Kuberbitcoin to complete"),
