    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; 2009-%1 ").arg(COPYRIGHT_YEAR) + tr("The Bitcoin Core developers") + QString("<br>") + tr("Copyright") + QString(" &copy; 2013-%1 ").arg(COPYRIGHT_YEAR) + tr("The Kuberbitcoin developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Kuberbitcoin Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  kuberbitcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Kuberbitcoin Core is shutting down...") + "<br /><br />" +
