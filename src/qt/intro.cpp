...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kuberbitcoin"),
     ...
     * override -datadir in the kuberbitcoin.conf file in the default data directory
     * (to be consistent with kuberbitcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
