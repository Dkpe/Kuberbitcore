...
static const int mAlgo_FORK = 19342; //19342 Block Fork Completed Correctly
static const int MAX_BLOCK_ALGO_COUNT = 6; // Maximum number block accepted by the same algorithm 6 per ALGO Only used for fork of 19342
static const int MAX_BLOCK_ALGO_COUNT_V2_START = 19351;  //19342 Block Fork Completed Correctly
static const int MAX_BLOCK_ALGO_COUNT_V2 = 10; // Maximum number block accepted by the same algorithm version 2  10 per ALGO
const int64_t multiAlgoDiffChangeTarget = 19342; //19342 Block Fork Completed Correctly
 ...
 */
// Kuberbitcoin specific implementation, standardizes checks for the hard maturity change at block 145k
