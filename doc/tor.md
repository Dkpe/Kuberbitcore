...
1. Run kuberbitcoin behind a Tor proxy
---------------------------------

The first step is running Kuberbitcoin behind a Tor proxy. This will already make all
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./kuberbitcoin -proxy=127.0.0.1:9050


2. Run a kuberbitcoin hidden server
------------------------------
...
your kuberbitcoind's P2P listen port (16639 by default).
	...
	-externalip=X   You can tell kuberbitcoin about its publicly reachable address using
	                ...
	                /var/lib/tor/kuberbitcoin-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./kuberbitcoind -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./kuberbitcoin -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
