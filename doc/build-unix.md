UNIX BUILD NOTES
====================
Some notes on how to build Kuberbitcoin in Unix. 
...
This will build kuberbitcoin-qt as well if the dependencies are met.
...
memory available when compiling Kuberbitcoin Core. With 512MB of memory or less
...
If you want to build Kuberbitcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a kuberbitcoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip kuberbitcoind" to strip the debug
...
cryptography functions, and therefore cannot be used for Kuberbitcoin (or other
...
Security
--------
To help make your kuberbitcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, kuberbitcoin should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, kuberbitcoin may be compiled in
