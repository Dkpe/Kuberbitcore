...
*Setup instructions for a gitian build of Kuberbitcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Kuberbitcoin
...
to http://github.com/kuberbitcoinproject/kuberbitcoin.
...
- [Building Kuberbitcoin](#building-kuberbitcoin)
...
Clone the git repositories for kuberbitcoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/kuberbitcoinproject/kuberbitcoin
```
...
In [doc/release-process.md](release-process.md) in the kuberbitcoin repository under 'Fetch and build inputs'.
...
Building Kuberbitcoin
----------------

To build Kuberbitcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the kuberbitcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/kuberbitcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/kuberbitcoinproject/kuberbitcoin
...
For example:
```bash
URL=https://github.com/langerhans/kuberbitcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit kuberbitcoin=${COMMIT} --url kuberbitcoin=${URL} ../kuberbitcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit kuberbitcoin=${COMMIT} --url kuberbitcoin=${URL} ../kuberbitcoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/kuberbitcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/kuberbitcoin-build.assert
```
...
[kuberbitcoin/gitian.sigs](https://github.com/kuberbitcoin/gitian.sigs/) repository, or
